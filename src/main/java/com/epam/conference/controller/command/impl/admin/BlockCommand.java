...
public class BlockCommand extends AbstractCommand {
    ...
    public BlockCommand(RequestParameterExtractor parameterExtractor, RequestParameterValidator parameterValidator,
    ...
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) throws ServiceException {
        ...
        Long blockUserId = extractor.extractLong(request, USER_ID_PARAMETER_NAME);
        if (!validator.isValid(USER_ID_PARAMETER_NAME, blockUserId)) {
