...
public class ConferenceServiceImpl extends AbstractService<Conference> implements ConferenceService {

    public ConferenceServiceImpl(DaoHelperFactory daoHelperFactory) {
        super(daoHelperFactory);
    }

    @Override
    public Long save(Conference conference, List<Section> sections) throws ServiceException {
    ...
    @Override
    protected Dao<Conference> getCurrentDao(DaoHelper factory) {
        return factory.createConferenceDao();
    }
